package com.crm.springbootjwtimplementation.util.Constants;
...
public class ApiMessages {
    ...
    public static final String MANAGER_NOT_FOUND = "Manager not found with ID: ";
    public static final String DEAL_NOT_FOUND = "Deal not found with ID: ";
